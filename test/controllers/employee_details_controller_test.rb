...
class EmployeeDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_detail" do
    assert_difference('EmployeeDetail.count') do
      post employee_details_url, params: { employee_detail: { Age: @employee_detail.Age, Gender: @employee_detail.Gender, Name: @employee_detail.Name, Role: @employee_detail.Role } }
    end
  ...
  test "should update employee_detail" do
    patch employee_detail_url(@employee_detail), params: { employee_detail: { Age: @employee_detail.Age, Gender: @employee_detail.Gender, Name: @employee_detail.Name, Role: @employee_detail.Role } }
